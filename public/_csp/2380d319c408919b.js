...
lp=lm?'/lua-config/'+lm[1]:'/lua-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/lua-config/'+lm[1]+'/search-index.json':'/lua-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}
